...
describe("Import Opportunities", () => {
  describe("generateCSVTemplate", () => {
    ...
    it("should have valid level values in samples", () => {
      ...
      expect(template).toContain("both");
    });

    it("should have valid type values in samples", () => {
      const template = generateCSVTemplate();

      expect(template).toContain("hybrid");
    });
    ...
    it("should have valid duration values in samples", () => {
      ...
      expect(template).toContain("long");
    });

    it("should default examples to unapproved", () => {
      const template = generateCSVTemplate();
    ...
    it("should not invent application deadlines", () => {
      const template = generateCSVTemplate();
